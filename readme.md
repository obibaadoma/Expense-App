...
**Expense App** is an transaction tracker app containing data about transactions based on categories. A user can register/login and create transactions to track them.
...
```sh
  cd project-folder
  git clone https://github.com/obibaadoma/Expense-App.git
```
...
- Twitter: [@ObibaKwekuAdoma](https://twitter.com/Obiba_Kweku_Adoma)
